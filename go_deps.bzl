...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:MgyEsX0IMwivwth1VwEnesBpH0vxbjp5a0w1lurMOXY=",
        version = "v1.38.60",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Nbsts7DdKThRHHd+YNlqiGlRqGEF2bE2eXN+xQ1hsEs=",
        version = "v0.1.1",
    )
    go_repository(
        name = "com_github_zeebo_pcg",
        importpath = "github.com/zeebo/pcg",
        sum = "h1:dt+dx+HvX8g7Un32rY9XWoYnd0NmKmrIzpHF7qiTDj0=",
        version = "v1.0.0",
    )
    go_repository(
